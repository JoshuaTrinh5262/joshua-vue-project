              ...
              <div class="card-body">
                <h5 class="card-title">Checkbox Buttons</h5>
                  <!-- <div class="text-center">
                    ...
                    <b-form-checkbox-group v-model="selected" buttons button-variant="primary" size="lg" name="buttons2" :options="options">
              ...
              <div class="card-body">
                <h5 class="card-title">Radio Buttons</h5>
                  <!-- <div class="text-center">
                    ...
                    <div class="divider"></div>
                    <b-form-radio-group id="btnradios2" buttons button-variant="outline-primary" size="lg" v-model="selected2" :options="options2" name="radioBtnOutline"/>
                    <div class="divider"></div>

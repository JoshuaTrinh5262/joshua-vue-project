  ...
  <div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="main-card mb-3 card">
          <div class="card-body">
            <h5 class="card-title">Center Dots</h5>
            <div class="center-time-line vertical-timeline vertical-timeline--animate vertical-timeline--one-column">
              <div class="dot-danger vertical-timeline-element">
                <div>
            ...
            <div
              ...
              <div class="vertical-timeline-element">
                <div>
                  ...
                  <div class="vertical-timeline-element-content bounce-in">
                    <h4 class="timeline-title">All Hands Meeting</h4>
                    <p>Test</p>
                    <div class="vertical-timeline-element-date bounce-in">
                      12-12-2024
                    </div>
                  </div>
                </div>
              ...
              <div class="vertical-timeline-element">
                <div>
                  ...
                  <div class="vertical-timeline-element-content bounce-in">
                    <h4 class="timeline-title">Build the production release</h4>
                    <p class="">What time do you go to sleep?</p>
                    <p class="">What time do you go to sleep?</p>
                    <p class="">What time do you go to sleep?</p>
                    <p class="">What time do you go to sleep?</p>
                    <p class="">What time do you go to sleep?</p>
              ...
              <div class="vertical-timeline-element">
                <div>
                  <span class="vertical-timeline-element-icon bounce-in"></span>
                  <div class="vertical-timeline-element-content bounce-in">
                    <h4 class="timeline-title text-danger">Something very important</h4>
                  </div>
                </div>
              </div>
            </div>

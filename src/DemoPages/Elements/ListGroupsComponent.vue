                  ...
                  <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-right">
                      <button class="btn-icon btn-icon-only btn btn-link"><i
                          class="pe-7s-download fsize-2 btn-icon-wrapper"> </i></button>
                    </div>
                  </div>
                </div>
              </li>
                  ...
                  <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-right widget-content-actions">
                      <div class="d-inline-block">
                        <div class="btn-group">
                          <button type="button" class="btn btn-icon btn-icon-only" data-toggle="dropdown"
        ...
        <div class="col-md-6">
          <div class="main-card mb-3 card">
            <div class="card-body">
              ...
              <ul class="list-group">
                <li class="justify-content-between list-group-item">Cras justo odio <span
                    class="badge badge-secondary badge-pill">14</span></li>
                <li class="justify-content-between list-group-item">Dapibus ac facilisis in <span
                    class="badge badge-secondary badge-pill">2</span></li>
                <li class="justify-content-between list-group-item">Morbi leo risus <span
                    class="badge badge-secondary badge-pill">1</span></li>
              </ul>
            </div>
          </div>
        </div>

  ...
  <div>
    ...
    <div class="content">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="main-card mb-3 card"><img src="@/assets/images/sidebar/abstract6.jpg" width="318" height="180" alt="Card image cap" class="card-img-top">
            ...
            <div class="main-card mb-3 card">
              ...
              <img src="@/assets/images/sidebar/abstract6.jpg" width="318" height="180"  alt="Card image cap" class="card-img-bottom"></div>
          </div>
          <div class="col-md-4">
            <div class="main-card mb-3 card">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="mb-3 card text-white"><img src="@/assets/images/sidebar/abstract6.jpg" width="318" height="180"  alt="Card image cap" class="card-img">

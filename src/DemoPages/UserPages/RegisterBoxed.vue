                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="form-group" id="exampleInputGroup2">
                                    ...
                                    <input type="text" class="form-control" id="exampleInput2" required placeholder="Enter username...">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInput3">Password</label>
                                            <input type="password" class="form-control" id="exampleInput3" required placeholder="Enter password...">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInput4">Repeat Password</label>
                                            <input type="password" class="form-control" id="exampleInput4" required placeholder="Repeat Password">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="exampleCheck" name="check">
                            ...
                            <div class="modal-footer d-block text-center">
                                <button class="btn btn-primary btn-lg btn-wide btn-pill btn-shadow btn-hover-shine">Create Account</button>
                            </div>
                        </div>
                    </div>

                    ...
                    <div class="card-body">
                        ...
                        <form class="">
                            ...
                            <div class="position-relative form-group"><label for="exampleSelect"
                                    class="">Select</label><select name="select" id="exampleSelect"
                                    class="form-control">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                        ...
                        <form class="">
                            <fieldset class="position-relative form-group">
                                <div class="position-relative form-check"><label class="form-check-label"><input
                                            name="radio1" type="radio" class="form-check-input"> Option one is this and
                                        that—be
                                        sure to include why it's great</label></div>
                                <div class="position-relative form-check"><label class="form-check-label"><input
                                            name="radio1" type="radio" class="form-check-input"> Option two can be
                                        something
                        ...
                        <div class="card-body">
                            ...
                            <div class="position-relative form-group">
                                <div>
                                    ...
                                    <div class="custom-checkbox custom-control"><input type="checkbox"
                                            id="exampleCustomCheckbox3" disabled class="custom-control-input"><label
                                            class="custom-control-label" for="exampleCustomCheckbox3">But not this
                            ...
                            <div class="position-relative form-group">
                                <div>
                                    ...
                                    <div class="custom-radio custom-control"><input type="radio"
                                            ...
                                            class="custom-control-input"><label class="custom-control-label"
                                            for="exampleCustomRadio2">Or this one</label></div>
                                    <div class="custom-radio custom-control"><input type="radio"
                                            id="exampleCustomRadio3" disabled class="custom-control-input"><label
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="position-relative form-group"><label for="exampleCustomMutlipleSelect"
                                            ...
                                            id="exampleCustomMutlipleSelect" name="customSelect" class="custom-select">
                                            <option value="">Select</option>
                                            <option>Value 1</option>
                                            <option>Value 2</option>
                                            <option>Value 3</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="position-relative form-group"><label
                                            ...
                                            id="exampleCustomMutlipleSelectDisabled" name="customSelect" disabled
                                            class="custom-select">
                                            <option value="">Select</option>
                                            <option>Value 1</option>
                                            <option>Value 2</option>

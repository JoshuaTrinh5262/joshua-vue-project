      ...
      <template #body>
        <div class="form">
          <div class="position-relative form-group">
            ...
            <input name="user_email" id="user_email" placeholder="Enter email..." type="email" class="form-control"
              autocomplete="off" v-model="currentUser.email">
            <small v-if="validationErrors.email" class="text-danger">{{ validationErrors.email }}</small>
          </div>
          <div class="position-relative form-group">
            <label for="user_password">User Password</label>
            <div class="input-group">
              <input name="user_password" :type="isPasswordVisible ? 'text' : 'password'" class="form-control"
                id="user_password" autocomplete="off" v-model="currentUser.password" placeholder="Enter password...">
